...
class ChartManager {
    ...
    calculateProjectedBalances(current, monthlyContribution, monthlyRate, months) {
    ...
    addGoalAnnotation(month, goalAmount) {
        ...
        console.log(`Goal of ${formatCurrency(goalAmount)} reached at month ${month}`);
    }
    ...
    getPerformanceMetrics(data) {
        ...
        return {
            ...
            interestBenefitPercentage: finalSimple > 0 ? (interestBenefit / finalSimple) * 100 : 0
        };
    }
